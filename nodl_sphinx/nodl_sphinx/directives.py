...
The rendering is a function from a :class:`~nodl_sphinx.summarize.NodeSummary` to a titled section,
...
Nodes are built directly rather than by nested-parsing generated markup,
which makes the result identical from rst and MyST sources,
and keeps document text out of the parser (a description is prose, not markup to be interpreted).
"""
...
from nodl_sphinx.summarize import ActionRow, EndpointRow, NodeSummary, ParameterRow, summarize_tree
