...
- **`nodl_sphinx`** — Sphinx extension that renders a NoDL document into a documentation page at build time.
  See the [Documenting guide](documenting.md).
...
nodl_sphinx <_generated/packages/nodl_sphinx/overview>
```
